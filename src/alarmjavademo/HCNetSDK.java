...
//
//    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary("C:\\/Windows\\/System32\\/HCNetSDK.dll",
//            HCNetSDK.class);
	
//    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary("C:\\Windows\\System32\\HCNetSDK.dll",
//            HCNetSDK.class);
//	String path = System.getProperty("java.library.path");
//    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(path+"\\HCNetSDK.dll",
//            HCNetSDK.class);

//    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(System.getProperty("java.library.path")+"\\HCNetSDK.dll",
//            HCNetSDK.class);
	
    HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary(Configs.dllPath,
            HCNetSDK.class);  //可用 System32
	
//	HCNetSDK INSTANCE = (HCNetSDK) Native.loadLibrary("C:/Windows/SysWOW64/HCNetSdk.dll",
//			HCNetSDK.class); 
...
public static class NET_DVR_TPS_ALARM_V41 extends Structure {
	...
	public int dwStopTime;    // 结束统计时间
      	public byte visibility;  //能见度
	public byte[] byRes = new byte[23];      // 保留
}
